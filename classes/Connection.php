...
class ConnectionCore extends ObjectModel {
	...
	protected $fieldsValidate = array ('id_guest' => 'isUnsignedId', 'id_page' => 'isUnsignedId', 'ip_address' => 'isInt', 'http_referer' => 'isAbsoluteUrl' );
	...
	public static function setPageConnection($cookie, $full = true) {
		...
		return array ('id_connections' => ( int ) ($cookie->id_connections), 'id_page' => ( int ) ($id_page), 'time_start' => $time_start );
	}
