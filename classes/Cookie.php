...
class CookieCore {
	...
	public function isLoggedBack() {
		...
		return ($this->id_employee and Validate::isUnsignedId ( $this->id_employee ) and Employee::checkPassword ( ( int ) $this->id_employee, $this->passwd ) and (! isset ( $this->_content ['remote_addr'] ) or $this->_content ['remote_addr'] == ip2long ( Tools::getRemoteAddr () ) or ! Configuration::get ( 'PS_COOKIE_CHECKIP' )));
	}
