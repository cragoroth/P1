...
class StockMvtCore extends ObjectModel {
	...
	protected $fieldsValidate = array ('id_product' => 'isUnsignedId', 'id_product_attribute' => 'isUnsignedId', 'id_order' => 'isUnsignedId', 'id_employee' => 'isUnsignedId', 'quantity' => 'isInt', 'id_stock_mvt_reason' => 'isUnsignedId' );
	
	protected $webserviceParameters = array ('objectsNodeName' => 'stock_movements', 'objectNodeName' => 'stock_movement', 'fields' => array ('id_product' => array ('xlink_resource' => 'products' ), 'id_product_attribute' => array ('xlink_resource' => 'product_option_values' ), 'id_order' => array ('xlink_resource' => 'orders' ), 'id_employee' => array ('xlink_resource' => 'employees' ), 'id_stock_mvt_reason' => array ('xlink_resource' => 'stock_movement_reasons' ) ) );
	...
	public function add($autodate = true, $nullValues = false, $update_quantity = true) {
		...
		if ($this->id_product_attribute) {
			...
			return (Db::getInstance ()->Execute ( '
				...
				AND `id_product_attribute` = ' . ( int ) $this->id_product_attribute ) && $product->updateQuantityProductWithAttributeQuantity ());
		} else
			return Db::getInstance ()->Execute ( '
